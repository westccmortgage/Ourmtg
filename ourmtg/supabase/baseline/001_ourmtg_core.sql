...
-- Human-reviewed bank-statement income analysis. Extraction and calculations are
-- server-only; borrowers receive only a reviewed summary through the portal gateway.
